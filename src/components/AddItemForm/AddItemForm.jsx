  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <button className={styles.close} onClick={() => { setOpen(false); setForm(EMPTY); setError(''); }} aria-label="Cancel">
          <X size={16} />
        </button>
      </div>
      ...
      <form onSubmit={submit} className={styles.form} noValidate>
        ...
        <div className={styles.formActions}>
          <button type="button" className={styles.cancelBtn} onClick={() => { setOpen(false); setForm(EMPTY); setError(''); }}>
            Cancel
          </button>
