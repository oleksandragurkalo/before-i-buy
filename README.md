...
> Think before you buy. Share what you want.

Part impulse-purchase tracker, part shared wishlist. Add things you want to buy, see how many **hours of net take-home pay** they actually cost, sit through a cooling-off period — and share the list with a friend so they can see what you're tempted by and help talk you down (or off the ledge), or just know what to get you.
...
- **Multiple lists** — create, rename, and switch between named lists (e.g. one to share, one to keep private); you always keep at least one — the last one can't be deleted
...
- Nav pill badges surface what needs attention: "Waiting List" counts items ready to decide, "Friends" counts pending friend requests
